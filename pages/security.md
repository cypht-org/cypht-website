...
<div class="d-flex flex-column justify-content-center gap-4"> 
  <section class="hero-security">
    <div class="hero-container col-10">
      ...
      <div class="sec-hero-image">
        <img src="/img/security/hero.webp" alt="Mail security illustration" width="1927" height="2177" loading="eager" fetchpriority="high" decoding="async" />
      </div>
    </div>
  </section>
  <!-- List -->
  <div class="mt-5">
    ...
    <!-- tabs content -->
    <div id="browser"  class="sec-list-content d-flex flex-column gap-5 px-4">
        <!-- 1 -->
          ...
          <div class="sec-tab-details col-12 col-lg-5 relative">
             <div class="sec-tab-line">
                <div class="sec-tab-d-one">
                  <h5 class="fw-bold">Browser Security</h5>
            ...
            <div class="sec-tab-details col-12 col-lg-5">
              <div class="sec-tab-line">
                <div class="sec-tab-d-two">
                  <h5 class="fw-bold">Server Security</h5>
          ...
          <div class="sec-tab-details col-12 col-lg-5">
            <div class="sec-tab-line">
              <div class="sec-tab-d-three">
                <h5 class="fw-bold">Development Security</h5>
