      ...
      <div class="ft-section">
            ...
            <div class="parent_test">
                  ...
                  <div class="mss-div5 mss-div">
                    <span class="mss-div-header"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><!-- Icon from Tabler Icons by Paweł Kuna - https://github.com/tabler/tabler-icons/blob/master/LICENSE --><path fill="currentColor" d="m15.113 3.21l.094.083l5.5 5.5a1 1 0 0 1-1.175 1.59l-3.172 3.171l-1.424 3.797a1 1 0 0 1-.158.277l-.07.08l-1.5 1.5a1 1 0 0 1-1.32.082l-.095-.083L9 16.415l-3.793 3.792a1 1 0 0 1-1.497-1.32l.083-.094L7.585 15l-2.792-2.793a1 1 0 0 1-.083-1.32l.083-.094l1.5-1.5a1 1 0 0 1 .258-.187l.098-.042l3.796-1.425l3.171-3.17a1 1 0 0 1 1.497-1.26z"/></svg>Tags & Labels</span>
            ...
            <div class="perf-parent">
                <div class="perf-div1 feature-card">
                   <div>
                    ...
                    <!--  -->
                   <div>
                          <img draggable="false" alt="Lightweight Pages" decoding="async" data-nimg="fill" class="hidden dark:block absolute inset-0 object-cover object-center xl:object-bottom" src="https://supabase.com/images/index/products/edge-functions-dark.svg" style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                   </div>
                </div>
                ...
                <div class="perf-div4 feature-card">
                   ...
                   <span class="ft-description">Easily move or copy emails between different accounts and folders for better organization.</span>
                     ...
                     <img draggable="false" alt="Supabase Authentication user db rows" decoding="async" data-nimg="fill" class="hidden dark:block absolute inset-0 object-cover object-center xl:object-bottom" src="https://supabase.com/images/index/products/auth.svg" style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent;">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="security-parent w-100">
                <div class="security-card">
                   ...
                   <span class="ft-description">Easily move or copy emails between different accounts and folders for better organization.</span>
                    ...
                    <div class="sec-img-content">
                        <img draggable="false" alt="Supabase Authentication user db rows" decoding="async" data-nimg="fill" src="/img/database.png">
                    </div>
                </div>
                <div class="security-card">
                    <div class="feat-card-header">
                ...
                <div class="security-card">
                   ...
                   <span class="ft-description">Easily move or copy emails between different accounts and folders for better organization.</span>
                    ...
                    <div class="sec-img-content">
                        <img draggable="false" alt="Supabase Authentication user db rows" decoding="async" data-nimg="fill"  src="https://supabase.com/images/index/products/auth.svg">
                    </div>
                </div>
            </div>
        </div>
