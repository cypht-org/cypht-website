...
<div class="doc-content-left col mx-xl-3">
    ...
    <div id="overview" class="doc-section">
        <div class="doc-section-header">
            <a href="#overview">Powerful Email Composition</a>
        </div>
        <span class="doc-section-text">
            Cypht provides a flexible and powerful email composition experience with support for multiple formats, rich editing options, and seamless integration with your configured accounts.
        </span>
    ...
    <div id="format_options" class="doc-section">
        <div class="doc-section-header">
            <a href="#format_options">Multiple Format Support</a>
        </div>
        <span class="doc-section-text">
            Choose the format that best suits your communication needs, from simple plain text to rich HTML or structured Markdown.
        </span>
        ...
        <div class="doc-subsection-header">
            <a href="#markdown_format">Markdown Format</a>
        </div>
        <div class="feature-card">
            <h6><i class="bi bi-markdown"></i> Markdown Support</h6>
    ...
    <div id="editor_features" class="doc-section">
        <div class="doc-section-header">
            <a href="#editor_features">Editor Features</a>
        </div>
        <span class="doc-section-text">
    ...
    <div id="account_integration" class="doc-section">
        <div class="doc-section-header">
            <a href="#account_integration">Account Integration</a>
        </div>
        <span class="doc-section-text">
            Seamlessly compose and send emails using any of your configured accounts with intelligent account management.
        </span>
    ...
    <div id="advanced_features" class="doc-section">
        <div class="doc-section-header">
    ...
    <div id="security_privacy" class="doc-section">
        <div class="doc-section-header">
            <a href="#security_privacy">Security & Privacy</a>
        </div>
        <span class="doc-section-text">
    ...
    <div id="productivity" class="doc-section">
        <div class="doc-section-header">
            <a href="#productivity">Productivity Features</a>
        </div>
        <span class="doc-section-text">
    ...
    <nav-pagination
        prev-label="Unified Inbox"
        prev-url="/documentation/unified-inbox"
        next-label="Search & Filters"
        next-url="/documentation/search-filters">
    </nav-pagination>
    ...
    <div class="dc-ctr-content">
        ...
        <nav>
            <ul id="dc-ctr-nav">
                ...
                <li><a href="#editor_features">Editor Features</a></li>
                <li><a href="#account_integration">Account Integration</a></li>
                <li><a href="#advanced_features">Advanced Features</a></li>
                <li><a href="#security_privacy">Security</a></li>
