...
<li>Add post/get variables if they exist in the list of allowed get/posts</li>
    ...
    <div id="internationalization" class="doc-section">
        ...
        <pre><code class="language-bash">$this->trans("Your text here");</code></pre>
        <p>Or with specific language:</p>
        <pre><code class="language-bash">hm_trans("Your text here", "en");</code></pre>
...
--configuration tests/phpunit/phpunit.xml \
 --filter classOrMethodName</code></pre>
    ...
    <div id="third_party" class="doc-section">
        ...
        <pre><code class="language-bash">Hm_Output_page_js.output</code></pre>

        <p><strong>For CSS files:</strong></p>
        <pre><code class="language-bash">Hm_Output_header_css.output</code></pre>
        <div class="doc-subsection-header">
        ...
        <pre><code class="language-bash">setup_base_page('test');</code></pre>
    ...
    'allowed_post' => array(...)
        ...
        <pre><code class="language-bash">add_output('test', 'test_heading', true, 'core', 'content_section_start', 'after');</code></pre>

        <p><strong>Step 5:</strong> Define the output class in core/modules.php:</p>
        <pre><code class="language-bash">class Hm_Output_test_heading extends Hm_Output_Module {
    protected function output() {
        ...
        <pre><code class="language-bash">add_output('test', 'test_first_div', true, 'core', 'test_heading', 'after');</code></pre>

        <pre><code class="language-bash">class Hm_Output_test_first_div extends Hm_Output_Module {
    protected function output() {
    ...
    <div id="core_module" class="doc-section">
        ...
        <div class="feature-card">
            <h6><i class="bi bi-lightbulb"></i> Module Dependencies</h6>
