...
<main>
    <section class="security-section" style="margin-top: 50px; padding-top:50px">
    ...
    <section class="content-section-doc container">
        <div class="line">
            <div  class="element1 item ">
                <img src="/img/google-oauth-screen/01.png" alt="google-oauth-screen">
            </div>
    ...
    <section class="content-section-doc container">
        <div class="line">
            ...
            <div  class="element2 item ">
                <img src="/img/google-oauth-screen/05.png" alt="google-oauth-screen">
            </div>
        </div>
    </section>
    <section class="content-section-doc container">
        <div class="line">
            <div  class="element1 item ">
                <img src="/img/google-oauth-screen/11.png" alt="google-oauth-screen">
            </div>
            <div  class="element2 item ">
    ...
    <section class="content-section-doc container">
        <div class="line">
            ...
            <div  class="element2 item ">
                <img src="/img/google-oauth-screen/12.png" alt="google-oauth-screen">
            </div>
        </div>
    </section>
    <section class="content-section-doc container">
        <div class="line">
            <div  class="element1 item ">
                <img src="/img/google-oauth-screen/07.png" alt="google-oauth-screen">
                <hr>
                <img src="/img/google-oauth-screen/10.png" alt="google-oauth-screen">
            </div>
            <div  class="element2 item ">
    ...
    <section class="content-section-doc container">
        <div class="line">
            ...
            <div  class="element2 item ">
                <img src="/img/google-oauth-screen/13.png" alt="google-oauth-screen">
                <hr>
                <img src="/img/google-oauth-screen/14.png" alt="google-oauth-screen">
            </div>
        </div>
    </section>
</main>