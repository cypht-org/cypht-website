...
<!--  -->
                <div class="d-none d-lg-flex flex-grow-1 ov-img">
                    <img src="/img/puzzle.webp" alt="Illustration of modular puzzle pieces" width="500" height="500" loading="eager" fetchpriority="high" decoding="async" class="object-fit-contain"  />
                </div>
            </div>
            <!--  -->
