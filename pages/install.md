...
install_cypht() {
    ...
    if [ "$version" == "master" ]; then
        echo "Downloading the latest development version (master branch)..."
        wget "https://github.com/cypht-org/cypht/archive/refs/heads/master.zip" -O "master.zip"
    else
        echo "Downloading version v$version_cleaned..."
    ...
    composer install | while read -r line; do
...
read -p "Enter the base directory for Cypht installation (default is /usr/local/share/cypht): " BASE_DIR
