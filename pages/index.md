    ...
    <section id="hero_minimal">
    	<div class="section-content home-hero">
            ...
            <div class="mini-stat d-flex align-items-center">
                ...
                <p class="stat-text d-flex flex-column mb-0"><span class="d-block">Trusted. With <a id="packagist-downloads" href="https://packagist.org/packages/jason-munro/cypht" target="_blank" class="fw-bold stat-indicator">162k+</a> Composer downloads</span><span class="d-block">and <a id="docker-pulls" href="https://hub.docker.com/r/cypht/cypht" target="_blank" class="fw-bold stat-indicator">158k+</a> Docker pulls worldwide</span></p>
            </div>
