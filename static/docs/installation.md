<div class="doc-content-left bg-primary col-11">
  ...
  <div id="why_cypht"  class="doc-section">
    <div class="doc-section-header">
          ...
          <p class="doc-section-text">Cypht is a revolutionary webmail client that transforms how you manage your email. Unlike traditional email clients, Cypht is designed from the ground up to be secure, private, and incredibly powerful.</p>
          <!--  -->
          <p class="doc-section-text">Built with modern web technologies and a focus on user privacy, Cypht allows you to:</p>
          <ul>
  ...
  <div id="community" class="doc-section">
    ...
    <div class="doc-section-content">
      ...
      <div class="tip-card tip-idea">
        ...
        <div>
        hello
          <span>click to view <a href="/contribute">Contribute Guide <i class="bi bi-box-arrow-up-right"></i></a> for more details to contribute to Cyphts</span>
        </div>
      </div>
    </div>
  </div>
</div>
<div class="doc-content-right d-none d-xl-flex col-lg-1">
