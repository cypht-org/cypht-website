...
Sieve filters provide powerful server-side email filtering and organization capabilities in Cypht.

## What are Sieve Filters?

Sieve is a programming language for email filtering that runs on the email server, allowing you to create rules that automatically process emails as they arrive.
